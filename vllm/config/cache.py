...
KVOffloadingBackend = Literal["native", "lmcache", "mma"]
...
class CacheConfig:
    ...
    'native' (vLLM native CPU offloading), 'lmcache', 'mma' (MMA NVLink
    multi-path relay for accelerated GPU<->CPU transfers).
